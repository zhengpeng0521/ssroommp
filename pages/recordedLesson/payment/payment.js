// pages/recordedLesson/payment/payment.js
...
Page({
  ...
  subscribeMessage() {
    wx.requestSubscribeMessage({
      tmplIds: ['RlqSxjnZX2D0hT6t52FeZW6FyJyAR1rOfZtqEBNOZt0'],
      success:(res)=>{
  ...
  processPay: function (data) {
    ...
    if (data.errorCode === 9000) {
      ...
      const url = "/pages/recordedLesson/payment-success/payment-success" + params
      wx.requestPayment({
